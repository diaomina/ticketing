...
public class Prep {
	...
	public Prep(Integer prepId, Integer trainId, Integer pmemberId, String startStation, String endStation,
			String trainNumber, String startTime, String endTime, Integer price, boolean way, Timestamp booktime) {
		this.prepId = prepId;
